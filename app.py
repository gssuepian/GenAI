...
#     <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap" rel="stylesheet">
#     <h6 style="color: #110301; font-family: 'Montserrat', sans-serif; font-weight: normal; text-align: center;">
#         Download your personalized skin analysis and recommendations.
#     </h6>
#     """, unsafe_allow_html=True)
...
#         # Create a button to generate and download the PDF
#         if st.button("Generate PDF"):
#             with st.spinner("Generating PDF report for download"):
#                 pdf = FPDF()
#                 pdf.add_page()
#                 pdf.set_auto_page_break(auto=True, margin=15)
...
#                 # Add introductory text
#                 pdf.set_font('Arial', '', 12)
#                 intro_text = "Dear Valued Customer,\n\nThank you for using our Skin & Makeup Analysis App. Based on your input and image, we have generated a personalized skin analysis and recommendations just for you.\n\n"
#                 pdf.multi_cell(0, 10, intro_text)
                
#                 # Add the AI's response
#                 pdf.set_font('Arial', '', 12)
#                 analysis_text = st.session_state.response
#                 pdf.multi_cell(0, 10, analysis_text)
                
#                 # Add concluding remarks
#                 pdf.ln(10)
#                 outro_text = "We hope you find these recommendations helpful. For more personalized advice, please visit our website or contact our support team.\n\nBest Regards,\nThe Skin & Makeup Analysis Team"
#                 pdf.multi_cell(0, 10, outro_text)

#                 report_path = "skin_analysis.pdf"
...
#         else:
#             st.write("No analysis found. Please run the Skin Analysis first.")
